    ...
    return RefreshIndicator(
      ...
      child: Scaffold(
        ...
        drawer: SafeArea(
          child: Drawer(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Text(authController.userModel.value!.firstName!,style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold,letterSpacing: 3),),
                  SizedBox(height: 20,),
        ...
        body: GetX<BookingController>(
          init: controller,
          builder: (controller) {
            return controller.loading.value ? Center(child: CircularProgressIndicator(),) :ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    ...
                    subtitle: buildDataText(context, 'Booking Type', booking.jobcard),
                    trailing: Row(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Get.defaultDialog(title: "Select Status",
                                content: Column(
                                  children: [
                                    buildInkWell("Picked Up",booking),
                                    buildInkWell("On The Way",booking),
                                    buildInkWell("Successfully Delivered",booking),
                                    buildInkWell("Cancelled",booking),
                                    buildInkWell("Address not Found",booking),
                    ...
                    children: [
                      ListTile(
                        title: buildDataText(context, 'Emp Code', booking.empId),
                      ),
                      ListTile(
                        title: buildDataText(context, 'Booking ID', booking.id),
                      ),
