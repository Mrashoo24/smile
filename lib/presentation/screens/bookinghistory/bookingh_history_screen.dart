...
import 'package:smile/data/models/addressModel.dart';
        ...
        body: GetX<BookingController>(
          ...
          builder: (controller) {
            return controller.loading.value ? const Center(
              child: CircularProgressIndicator(),) : FutureBuilder(
                future: Future.wait(
                ...
                builder: (context, futures) {
                  ...
                  var companyAddress = futures.requireData[0] as List<Company>;
                  var labAddress = futures.requireData[1] as List<DentalLab>;
